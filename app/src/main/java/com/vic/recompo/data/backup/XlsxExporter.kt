...
class XlsxExporter(
    ...
    suspend fun generarBytes(): ByteArray {
        ...
        if (settings != null) {
            ...
            resumen += listOf("Kcal descanso", settings.kcalDescanso.toString())
            resumen += listOf("Kcal musculación", settings.kcalMusculacion.toString())
            resumen += listOf("Kcal bici", settings.kcalBici.toString())
            resumen += listOf("Metabolismo basal (kcal)", settings.metabolismoBasalKcal.toString())
